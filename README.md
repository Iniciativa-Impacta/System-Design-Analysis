...
- Dominar a Linguagem de Modelagem Unificada (UML)
- Aplicar os conceitos em um projeto real
...
```
docs/
├── PARTE1.md        # Introdução e Necessidade de Modelagem
├── PARTE2.md        # Engenharia de Requisitos - Conceitos e Fundamentos
├── PARTE3.md        # SRS e Artefatos de Software
├── PARTE4.md        # Exercício Prático - Sistema de Biblioteca
├── PARTE5.md        # Checklist de Validação de Requisitos
...
- Fornece base para design e implementação
- Permite evoluir e adaptar o sistema ao longo do tempo

### 2. **Benefícios da Modelagem**
- **Clareza:** Tradução visual de requisitos
- **Economia de Custos:** Identificação de problemas antes da implementação
- **Colaboração:** Comunicação eficiente entre equipes
- **Escalabilidade:** Maior facilidade para evolução

### 3. **Requisitos de Software**
- **Funcionais:** O que o software deve fazer
- **Não-Funcionais:** Como o software deve fazer (desempenho, segurança, usabilidade)
- **Restrições:** Limitações e imposições
...
3. **Modelagem UML:** Diagramas de casos de uso, classes e sequência
